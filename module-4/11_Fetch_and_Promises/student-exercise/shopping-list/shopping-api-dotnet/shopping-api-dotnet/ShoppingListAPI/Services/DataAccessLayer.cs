...
namespace ShoppingListAPI.Services
{
    public class DataAccessLayer : IDataAccessLayer<Item>
    {
        ...
        public DataAccessLayer()
        {
            ...
            {
                new Item { Id=1,name="Oatmeal",completed=true},
                new Item { Id=2,name="Milk",completed=true},
                new Item { Id=3,name="Banana",completed=true},
                new Item { Id=4,name="Strawberries",completed=true},
